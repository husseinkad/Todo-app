...
class _HomePageState extends State<HomePage> {
  ...
  // is the upper first part of the app in the homepage
  _addTaskBar() {
    return Container(
  ...
  // is the date down the add task button
  _addDateBar() {
    return Container(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('You do not have any task yet\nadd new task to make your day productive', style: subTitleStyle, textAlign: TextAlign.center,),
                  ),
                  SizeConfig.orientation == Orientation.landscape
